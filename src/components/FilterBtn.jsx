...
export default function FilterBtn({ isSelected, setIsSelected }) {
  ...
  return (
    <>
      <label
        htmlFor={htmlFor}
        className={
          isSelected.remain === value || isSelected.nearby === value
            ? 'filter-list_box_group_label selected'
            : 'filter-list_box_group_label'
        }
      >
        {children}
      </label>
